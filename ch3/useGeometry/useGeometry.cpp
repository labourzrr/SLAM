...
int main( int argc ,char** argv )
{
    ...
    Eigen::Isometry3d T=Eigen::Isometry3d::Identity(); //虽然成为3D，实质上是4X4矩阵
    T.rotate (rotation_vector ); //按照rotation_vector进行旋转
    T.pretranslate (Eigen::Vector3d(1,3,4)); //把评议向量设成（1,3,4）
    ...
    //对于仿射和射影变换，使用Eigen::Affine3d 和Eigen::Projective3d即可，略
